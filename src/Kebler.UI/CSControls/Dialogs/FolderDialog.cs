namespace Kebler.UI.CSControls.Dialogs
{
    ...
    public class FolderDialog
    {
        ...
        public delegate int CallBackAction(IntPtr hwnd, MessageFromBrowser uMsg, IntPtr lParam, IntPtr lpData);
        ...
        private static extern IntPtr SHBrowseForFolderW([MarshalAs(UnmanagedType.LPStruct)][In][Out] FolderInfo bi);
